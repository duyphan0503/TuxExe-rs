...
fn default_drives_and_folders() -> &'static (DriveMap, SpecialFolders) {
    static DRIVES_AND_FOLDERS: std::sync::OnceLock<(DriveMap, SpecialFolders)> =
                ...
                && lower_name.ends_with(".png")
            {
                if let Some(parent) = translated.parent() {
                    ...
                    if let Some(actual_parent) = actual_parent {
                        ...
                        let prefix =
                            if lower_name.starts_with("savemap") { "savemap" } else { "saveimage" };
                        ...
                        if !copied {
                            ...
                            const VALID_FALLBACK_PNG: &[u8] = &[
                                ...
                                ,
                                ...
                                0x43, 0x98, 0x81, 0x21, 0xCC, 0xC0, 0x10, 0x66, 0x60, 0x08, 0x33,
                                0x30, 0x84, 0x19, 0x18, 0xC2, 0x0C, 0x0C, 0x61, 0x06, 0x86, 0x30,
                                0x03, 0x43, 0xD8, 0x05, 0xAF, 0x6C, 0xCA, 0x29, 0xAB, 0x98, 0x52,
                                0x84, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4E, 0x44, 0xAE, 0x42,
                                0x60, 0x82,
                            ];
...
pub fn nt_create_file(
    ...
    let flags = if is_dir {
        ...
        open_flags(read, write, disposition)
    };
    let mode = 0o644;
...
pub fn nt_read_file_at(
    ...
    global_table().with(handle, |obj| {
        ...
        if let Some(fd) = fd {
            let read_sz =
                unsafe { libc::pread(fd, buffer, length as libc::size_t, offset as libc::off_t) };
            if read_sz >= 0 {
                if let Some(br) = bytes_read {
                    *br = read_sz as u32;
                }
